  ...
  with WithExtendedTraceport
{
  ...
  def this(params: TestTileParams, crossing: RocketCrossingParams, lookup: LookupByHartIdImpl, logicalTreeNode: LogicalTreeNode)(implicit p: Parameters) =
  ...
  override lazy val module = new TestTileModuleImp(this)
 ...
 */
class TestTileModuleImp(outer: TestTile) extends BaseTileModuleImp(outer){
  ...
  override def toString: String = TestTileStr
