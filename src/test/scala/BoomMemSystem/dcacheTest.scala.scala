...
class DcacheTestSpec extends AnyFreeSpec with ChiselScalatestTester{
    ...
    // "DcacheTestSpec should compile" in {
    //     test(new BoomNonBlockingDCache(0)(para) ) { c =>
